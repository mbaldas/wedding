...
const items = [
  {
    ...
    imageUrl:
      'https://images.pexels.com/photos/2079698/pexels-photo-2079698.jpeg',
    creditCard: 'https://link.mercadopago.com.br/adriematheus',
  },
  {
    name: 'Assadeira',
    price: 'R$ 60,00',
      ...
      <div className='flex space-x-8'>
        <div className='w-1/3'>
          ...
          <p className='mt-4 text-base text-gray-600'>
            Você pode comprar diretamente pelo site clicando nas opções de Pix
            ou Cartão. Se preferir, pode enviar o presente diretamente para o
            nosso endereço:
          </p>
              ...
              >
                ...
                <div className='flex divide-x divide-gray-200'>
                  <a
                    ...
                    className='relative flex-1 inline-flex items-center justify-center gap-x-3 border border-transparent py-2 text-sm font-semibold text-gray-800 rounded-bl-lg hover:bg-gray-200'
                  >
                    <QrCodeIcon
                      aria-hidden='true'
                  ...
                  <a
                    href={item.creditCard}
                    className='relative flex-1 inline-flex items-center justify-center gap-x-3 py-2 text-sm font-semibold text-gray-800 rounded-br-lg hover:bg-gray-200'
                  >
                    <CreditCardIcon
                      aria-hidden='true'
                      className='h-5 w-5 text-gray-500'
